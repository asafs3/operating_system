...
_zombiecreate:     file format elf32-i386
...
int main(){
  ...
  18:	e8 33 04 00 00       	call   450 <printf>
    int pid = fork();
  1d:	e8 b9 02 00 00       	call   2db <fork>
    if(pid < 0) {
  22:	83 c4 10             	add    $0x10,%esp
  25:	85 c0                	test   %eax,%eax
  27:	78 47                	js     70 <main+0x70>
        printf(1, "zombiefailed\n");
        exit(); 
        }
    if(pid == 0){
  29:	75 13                	jne    3e <main+0x3e>
        printf(1, "child exit\n");
  2b:	50                   	push   %eax
  2c:	50                   	push   %eax
  2d:	68 93 07 00 00       	push   $0x793
  32:	6a 01                	push   $0x1
  34:	e8 17 04 00 00       	call   450 <printf>
        exit();
  39:	e8 a5 02 00 00       	call   2e3 <exit>
        }
    else {
        printf(1, "father sleep\n");
  3e:	50                   	push   %eax
  3f:	50                   	push   %eax
  40:	68 9f 07 00 00       	push   $0x79f
  45:	6a 01                	push   $0x1
  47:	e8 04 04 00 00       	call   450 <printf>
        sleep(1000); 
  4c:	c7 04 24 e8 03 00 00 	movl   $0x3e8,(%esp)
  53:	e8 1b 03 00 00       	call   373 <sleep>
        printf(1, "father wake\n");
  58:	5a                   	pop    %edx
  59:	59                   	pop    %ecx
  5a:	68 ad 07 00 00       	push   $0x7ad
  5f:	6a 01                	push   $0x1
