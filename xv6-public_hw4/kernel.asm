...
8010380c:	00 00 00 
  p->timerTicksLeft = 1; // priority level = 0 : 2^0 timer ticks
8010380f:	c7 83 84 00 00 00 01 	movl   $0x1,0x84(%ebx)
80103816:	00 00 00 
  release(&ptable.lock);
...
8010381e:	89 15 04 a0 10 80    	mov    %edx,0x8010a004
  release(&ptable.lock);
80103824:	e8 c7 0f 00 00       	call   801047f0 <release>
...
80103846:	89 53 18             	mov    %edx,0x18(%ebx)
  *(uint*)sp = (uint)trapret;
80103849:	c7 40 14 7d 5b 10 80 	movl   $0x80105b7d,0x14(%eax)
  p->context = (struct context*)sp;
...
80103858:	e8 b3 10 00 00       	call   80104910 <memset>
...
801038bb:	e8 30 0f 00 00       	call   801047f0 <release>
...
80103910:	e8 6b 0d 00 00       	call   80104680 <initlock>
}
...
801039a4:	83 ec 04             	sub    $0x4,%esp
  pushcli();
801039a7:	e8 54 0d 00 00       	call   80104700 <pushcli>
  c = mycpu();
801039ac:	e8 6f ff ff ff       	call   80103920 <mycpu>
  p = c->proc;
801039b1:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
801039b7:	e8 94 0d 00 00       	call   80104750 <popcli>
}
...
801039e3:	e8 a8 37 00 00       	call   80107190 <setupkvm>
...
80103a01:	e8 3a 34 00 00       	call   80106e40 <inituvm>
...
80103a16:	e8 f5 0e 00 00       	call   80104910 <memset>
...
80103a75:	e8 56 10 00 00       	call   80104ad0 <safestrcpy>
  p->cwd = namei("/");
...
80103ac5:	8b 75 08             	mov    0x8(%ebp),%esi
  pushcli();
80103ac8:	e8 33 0c 00 00       	call   80104700 <pushcli>
  c = mycpu();
80103acd:	e8 4e fe ff ff       	call   80103920 <mycpu>
  p = c->proc;
80103ad2:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103ad8:	e8 73 0c 00 00       	call   80104750 <popcli>
  sz = curproc->sz;
...
80103aeb:	e8 40 32 00 00       	call   80106d30 <switchuvm>
  return 0;
...
80103b46:	83 ec 1c             	sub    $0x1c,%esp
  pushcli();
80103b49:	e8 b2 0b 00 00       	call   80104700 <pushcli>
  c = mycpu();
80103b4e:	e8 cd fd ff ff       	call   80103920 <mycpu>
  p = c->proc;
80103b53:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103b59:	e8 f2 0b 00 00       	call   80104750 <popcli>
  if((np = allocproc()) == 0){
...
80103b78:	e8 03 37 00 00       	call   80107280 <copyuvm>
...
80103c81:	83 ec 0c             	sub    $0xc,%esp
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103c84:	be 54 1d 11 80       	mov    $0x80111d54,%esi
    acquire(&ptable.lock);
80103c89:	68 20 1d 11 80       	push   $0x80111d20
80103c8e:	e8 bd 0b 00 00       	call   80104850 <acquire>
80103c93:	83 c4 10             	add    $0x10,%esp
80103c96:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
80103c9d:	8d 76 00             	lea    0x0(%esi),%esi
      if(p->state != RUNNABLE)
80103ca0:	83 7e 0c 03          	cmpl   $0x3,0xc(%esi)
80103ca4:	75 4a                	jne    80103cf0 <scheduler+0x90>
      switchuvm(p);
80103ca6:	83 ec 0c             	sub    $0xc,%esp
      c->proc = p;
80103ca9:	89 b3 ac 00 00 00    	mov    %esi,0xac(%ebx)
      switchuvm(p);
...
80103cb5:	58                   	pop    %eax
80103cb6:	5a                   	pop    %edx
80103cb7:	ff 76 1c             	push   0x1c(%esi)
80103cba:	57                   	push   %edi
      p->nrswitch++;
80103cbb:	83 46 7c 01          	addl   $0x1,0x7c(%esi)
      p->state = RUNNING;
80103cbf:	c7 46 0c 04 00 00 00 	movl   $0x4,0xc(%esi)
      swtch(&(c->scheduler), p->context);
80103cc6:	e8 60 0e 00 00       	call   80104b2b <swtch>
      switchkvm();
80103ccb:	e8 50 30 00 00       	call   80106d20 <switchkvm>
      p->timerTicksLeft = 1 << p->priority;
80103cd0:	ba 01 00 00 00       	mov    $0x1,%edx
80103cd5:	83 c4 10             	add    $0x10,%esp
      c->proc = 0;
80103cd8:	c7 83 ac 00 00 00 00 	movl   $0x0,0xac(%ebx)
80103cdf:	00 00 00 
      p->timerTicksLeft = 1 << p->priority;
80103ce2:	8b 8e 80 00 00 00    	mov    0x80(%esi),%ecx
80103ce8:	d3 e2                	shl    %cl,%edx
80103cea:	89 96 84 00 00 00    	mov    %edx,0x84(%esi)
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103cf0:	81 c6 88 00 00 00    	add    $0x88,%esi
80103cf6:	81 fe 54 3f 11 80    	cmp    $0x80113f54,%esi
80103cfc:	75 a2                	jne    80103ca0 <scheduler+0x40>
    release(&ptable.lock);
80103cfe:	83 ec 0c             	sub    $0xc,%esp
80103d01:	68 20 1d 11 80       	push   $0x80111d20
80103d06:	e8 e5 0a 00 00       	call   801047f0 <release>
    sti();
80103d0b:	83 c4 10             	add    $0x10,%esp
80103d0e:	e9 6d ff ff ff       	jmp    80103c80 <scheduler+0x20>
...
80103d83:	e8 a3 0d 00 00       	call   80104b2b <swtch>
  mycpu()->intena = intena;
...
80103e4a:	e8 01 0a 00 00       	call   80104850 <acquire>
...
80103ef7:	68 a8 7a 10 80       	push   $0x80107aa8
80103efc:	e8 7f c4 ff ff       	call   80100380 <panic>
    panic("init exiting");
80103f01:	83 ec 0c             	sub    $0xc,%esp
80103f04:	68 9b 7a 10 80       	push   $0x80107a9b
...
80103f15:	e8 e6 07 00 00       	call   80104700 <pushcli>
  c = mycpu();
80103f1a:	e8 01 fa ff ff       	call   80103920 <mycpu>
  p = c->proc;
...
80103f81:	0f 85 8f 00 00 00    	jne    80104016 <wait+0x106>
  pushcli();
80103f87:	e8 74 07 00 00       	call   80104700 <pushcli>
  c = mycpu();
80103f8c:	e8 8f f9 ff ff       	call   80103920 <mycpu>
  p = c->proc;
80103f91:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103f97:	e8 b4 07 00 00       	call   80104750 <popcli>
  if(p == 0)
...
80103fd9:	e8 32 31 00 00       	call   80107110 <freevm>
        p->pid = 0;
...
80104005:	e8 e6 07 00 00       	call   801047f0 <release>
        return pid;
...
8010404c:	e8 ff 07 00 00       	call   80104850 <acquire>
  pushcli();
80104051:	e8 aa 06 00 00       	call   80104700 <pushcli>
  c = mycpu();
80104056:	e8 c5 f8 ff ff       	call   80103920 <mycpu>
  p = c->proc;
8010405b:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80104061:	e8 ea 06 00 00       	call   80104750 <popcli>
...
80104079:	e8 72 07 00 00       	call   801047f0 <release>
}
...
8010409c:	8b 75 0c             	mov    0xc(%ebp),%esi
  pushcli();
8010409f:	e8 5c 06 00 00       	call   80104700 <pushcli>
  c = mycpu();
801040a4:	e8 77 f8 ff ff       	call   80103920 <mycpu>
  p = c->proc;
801040a9:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
801040af:	e8 9c 06 00 00       	call   80104750 <popcli>
  if(p == 0)
...
801040d0:	e8 7b 07 00 00       	call   80104850 <acquire>
    release(lk);
801040d5:	89 34 24             	mov    %esi,(%esp)
801040d8:	e8 13 07 00 00       	call   801047f0 <release>
  p->chan = chan;
...
801040fa:	e8 f1 06 00 00       	call   801047f0 <release>
    acquire(lk);
...
8010410b:	5d                   	pop    %ebp
    acquire(lk);
8010410c:	e9 3f 07 00 00       	jmp    80104850 <acquire>
...
80104139:	68 ba 7a 10 80       	push   $0x80107aba
8010413e:	e8 3d c2 ff ff       	call   80100380 <panic>
    panic("sleep");
80104143:	83 ec 0c             	sub    $0xc,%esp
80104146:	68 b4 7a 10 80       	push   $0x80107ab4
...
8010415f:	e8 ec 06 00 00       	call   80104850 <acquire>
...
801041a4:	c9                   	leave  
  release(&ptable.lock);
801041a5:	e9 46 06 00 00       	jmp    801047f0 <release>
...
801041bf:	e8 8c 06 00 00       	call   80104850 <acquire>
...
801041fd:	e8 ee 05 00 00       	call   801047f0 <release>
      return 0;
    }
  }
  release(&ptable.lock);
...
80104218:	e8 d3 05 00 00       	call   801047f0 <release>
}
...
8010424b:	68 4b 7e 10 80       	push   $0x80107e4b
...
8010426f:	74 e7                	je     80104258 <procdump+0x28>
      state = "???";
80104271:	ba cb 7a 10 80       	mov    $0x80107acb,%edx
    if(p->state >= 0 && p->state < NELEM(states) && states[p->state])
80104276:	83 f8 05             	cmp    $0x5,%eax
80104279:	77 11                	ja     8010428c <procdump+0x5c>
8010427b:	8b 14 85 2c 7b 10 80 	mov    -0x7fef84d4(,%eax,4),%edx
      state = "???";
80104282:	b8 cb 7a 10 80       	mov    $0x80107acb,%eax
...
80104291:	68 cf 7a 10 80       	push   $0x80107acf
...
801042b8:	e8 e3 03 00 00       	call   801046a0 <getcallerpcs>
      for(i=0; i<10 && pc[i] != 0; i++)
...
801042cd:	68 21 75 10 80       	push   $0x80107521
...
801042f3:	53                   	push   %ebx
  struct proc *p;
  int NumProc = 0;
801042f4:	31 db                	xor    %ebx,%ebx
{ 
801042f6:	83 ec 10             	sub    $0x10,%esp

  acquire(&ptable.lock);
801042f9:	68 20 1d 11 80       	push   $0x80111d20
801042fe:	e8 4d 05 00 00       	call   80104850 <acquire>
80104303:	83 c4 10             	add    $0x10,%esp
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104306:	b8 54 1d 11 80       	mov    $0x80111d54,%eax
8010430b:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
8010430f:	90                   	nop
      if (p->state != UNUSED){
        NumProc++;
80104310:	83 78 0c 01          	cmpl   $0x1,0xc(%eax)
80104314:	83 db ff             	sbb    $0xffffffff,%ebx
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104317:	05 88 00 00 00       	add    $0x88,%eax
8010431c:	3d 54 3f 11 80       	cmp    $0x80113f54,%eax
...
8010432b:	e8 c0 04 00 00       	call   801047f0 <release>
  return NumProc;
...
80104343:	53                   	push   %ebx
  struct proc *p;
  int MaxPid = 0;
80104344:	31 db                	xor    %ebx,%ebx
{ 
80104346:	83 ec 10             	sub    $0x10,%esp

  acquire(&ptable.lock);
80104349:	68 20 1d 11 80       	push   $0x80111d20
8010434e:	e8 fd 04 00 00       	call   80104850 <acquire>
80104353:	83 c4 10             	add    $0x10,%esp
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104356:	b8 54 1d 11 80       	mov    $0x80111d54,%eax
8010435b:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
8010435f:	90                   	nop
      if( (p->state != UNUSED) && (MaxPid <= p->pid) ){
80104360:	8b 50 0c             	mov    0xc(%eax),%edx
80104363:	85 d2                	test   %edx,%edx
80104365:	74 08                	je     8010436f <getMaxPid+0x2f>
80104367:	8b 50 10             	mov    0x10(%eax),%edx
8010436a:	39 d3                	cmp    %edx,%ebx
8010436c:	0f 4c da             	cmovl  %edx,%ebx
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
8010436f:	05 88 00 00 00       	add    $0x88,%eax
80104374:	3d 54 3f 11 80       	cmp    $0x80113f54,%eax
80104379:	75 e5                	jne    80104360 <getMaxPid+0x20>
        MaxPid = p->pid;
      }     
    }
  release(&ptable.lock);
...
80104383:	e8 68 04 00 00       	call   801047f0 <release>
  return MaxPid;
...
80104398:	8d 48 40             	lea    0x40(%eax),%ecx
8010439b:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
8010439f:	90                   	nop
  for (int i=0 ; i < NOFILE ; i++){
    if (ofile[i] != NULL){
      open ++;
801043a0:	83 38 01             	cmpl   $0x1,(%eax)
801043a3:	83 da ff             	sbb    $0xffffffff,%edx
  for (int i=0 ; i < NOFILE ; i++){
801043a6:	83 c0 04             	add    $0x4,%eax
801043a9:	39 c8                	cmp    %ecx,%eax
801043ab:	75 f3                	jne    801043a0 <countOfiles+0x10>
    }
  }
  return open;
}
801043ad:	89 d0                	mov    %edx,%eax
801043af:	5d                   	pop    %ebp
801043b0:	c3                   	ret    
...
801043c5:	8d 45 f4             	lea    -0xc(%ebp),%eax
{
801043c8:	83 ec 18             	sub    $0x18,%esp
  if ( (argint(0, &pid) < 0) || (argptr(1, (void*)&info, sizeof(*info)) < 0) )
801043cb:	50                   	push   %eax
801043cc:	6a 00                	push   $0x0
801043ce:	e8 fd 07 00 00       	call   80104bd0 <argint>
801043d3:	83 c4 10             	add    $0x10,%esp
801043d6:	85 c0                	test   %eax,%eax
801043d8:	0f 88 db 00 00 00    	js     801044b9 <getProcInfo+0xf9>
801043de:	83 ec 04             	sub    $0x4,%esp
801043e1:	8d 45 f0             	lea    -0x10(%ebp),%eax
801043e4:	6a 14                	push   $0x14
801043e6:	50                   	push   %eax
801043e7:	6a 01                	push   $0x1
801043e9:	e8 32 08 00 00       	call   80104c20 <argptr>
801043ee:	83 c4 10             	add    $0x10,%esp
801043f1:	85 c0                	test   %eax,%eax
801043f3:	0f 88 c0 00 00 00    	js     801044b9 <getProcInfo+0xf9>
    return -1;
...
801043fc:	bb ff ff ff ff       	mov    $0xffffffff,%ebx
  acquire(&ptable.lock);
80104401:	68 20 1d 11 80       	push   $0x80111d20
80104406:	e8 45 04 00 00       	call   80104850 <acquire>
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
8010440b:	ba 7c 1d 11 80       	mov    $0x80111d7c,%edx
80104410:	83 c4 10             	add    $0x10,%esp
80104413:	eb 11                	jmp    80104426 <getProcInfo+0x66>
80104415:	8d 76 00             	lea    0x0(%esi),%esi
80104418:	81 c2 88 00 00 00    	add    $0x88,%edx
8010441e:	81 fa 7c 3f 11 80    	cmp    $0x80113f7c,%edx
80104424:	74 6a                	je     80104490 <getProcInfo+0xd0>
    if(p->state != UNUSED && p->pid == pid){
80104426:	8b 42 e4             	mov    -0x1c(%edx),%eax
80104429:	85 c0                	test   %eax,%eax
8010442b:	74 eb                	je     80104418 <getProcInfo+0x58>
8010442d:	8b 75 f4             	mov    -0xc(%ebp),%esi
80104430:	39 72 e8             	cmp    %esi,-0x18(%edx)
80104433:	75 e3                	jne    80104418 <getProcInfo+0x58>
      ...
      found = 0;
      info->state = p->state;
80104435:	8b 4d f0             	mov    -0x10(%ebp),%ecx
80104438:	89 01                	mov    %eax,(%ecx)
      if (pid != 1) {
8010443a:	83 7d f4 01          	cmpl   $0x1,-0xc(%ebp)
        info->ppid = p->parent->pid;
8010443e:	8b 75 f0             	mov    -0x10(%ebp),%esi
      if (pid != 1) {
80104441:	74 6d                	je     801044b0 <getProcInfo+0xf0>
        info->ppid = p->parent->pid;
80104443:	8b 42 ec             	mov    -0x14(%edx),%eax
80104446:	8b 40 10             	mov    0x10(%eax),%eax
80104449:	89 46 04             	mov    %eax,0x4(%esi)
      }
      else {
        info->ppid = 0;
      }
      ...
      info->sz = p->sz;
8010444c:	8b 42 d8             	mov    -0x28(%edx),%eax
  int open = 0;
8010444f:	31 c9                	xor    %ecx,%ecx
80104451:	8d 5a 40             	lea    0x40(%edx),%ebx
      info->sz = p->sz;
80104454:	89 46 08             	mov    %eax,0x8(%esi)
80104457:	89 d0                	mov    %edx,%eax
80104459:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
      open ++;
80104460:	83 38 01             	cmpl   $0x1,(%eax)
80104463:	83 d9 ff             	sbb    $0xffffffff,%ecx
  for (int i=0 ; i < NOFILE ; i++){
80104466:	83 c0 04             	add    $0x4,%eax
80104469:	39 d8                	cmp    %ebx,%eax
8010446b:	75 f3                	jne    80104460 <getProcInfo+0xa0>
      info->nfd= countOfiles(p->ofile);
8010446d:	89 4e 0c             	mov    %ecx,0xc(%esi)
      info->nrswitch = p->nrswitch;
80104470:	8b 42 54             	mov    0x54(%edx),%eax
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104473:	81 c2 88 00 00 00    	add    $0x88,%edx
      found = 0;
80104479:	31 db                	xor    %ebx,%ebx
      info->nrswitch = p->nrswitch;
8010447b:	89 46 10             	mov    %eax,0x10(%esi)
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
8010447e:	81 fa 7c 3f 11 80    	cmp    $0x80113f7c,%edx
80104484:	75 a0                	jne    80104426 <getProcInfo+0x66>
...
80104493:	68 20 1d 11 80       	push   $0x80111d20
80104498:	e8 53 03 00 00       	call   801047f0 <release>
  return found;
...
801044a9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
        info->ppid = 0;
801044b0:	c7 46 04 00 00 00 00 	movl   $0x0,0x4(%esi)
801044b7:	eb 93                	jmp    8010444c <getProcInfo+0x8c>
    return -1;
801044b9:	bb ff ff ff ff       	mov    $0xffffffff,%ebx
801044be:	eb e0                	jmp    801044a0 <getProcInfo+0xe0>
...
801044c5:	8b 75 08             	mov    0x8(%ebp),%esi
  pushcli();
801044c8:	e8 33 02 00 00       	call   80104700 <pushcli>
  c = mycpu();
801044cd:	e8 4e f4 ff ff       	call   80103920 <mycpu>
  p = c->proc;
801044d2:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
801044d8:	e8 73 02 00 00       	call   80104750 <popcli>

  struct proc *proc = myproc();
  // setting a value in the process table, needs to lock for synchronization matters
  acquire(&ptable.lock);
801044dd:	83 ec 0c             	sub    $0xc,%esp
801044e0:	68 20 1d 11 80       	push   $0x80111d20
801044e5:	e8 66 03 00 00       	call   80104850 <acquire>
  proc->priority = priority;
  proc->timerTicksLeft = 1 << priority;
801044ea:	89 f1                	mov    %esi,%ecx
801044ec:	b8 01 00 00 00       	mov    $0x1,%eax
  proc->priority = priority;
801044f1:	89 b3 80 00 00 00    	mov    %esi,0x80(%ebx)
  proc->timerTicksLeft = 1 << priority;
801044f7:	d3 e0                	shl    %cl,%eax
801044f9:	89 83 84 00 00 00    	mov    %eax,0x84(%ebx)
  release(&ptable.lock);
801044ff:	c7 04 24 20 1d 11 80 	movl   $0x80111d20,(%esp)
80104506:	e8 e5 02 00 00       	call   801047f0 <release>
...
80104524:	83 ec 04             	sub    $0x4,%esp
  pushcli();
80104527:	e8 d4 01 00 00       	call   80104700 <pushcli>
  c = mycpu();
8010452c:	e8 ef f3 ff ff       	call   80103920 <mycpu>
  p = c->proc;
80104531:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80104537:	e8 14 02 00 00       	call   80104750 <popcli>
  return myproc()->priority;
8010453c:	8b 83 80 00 00 00    	mov    0x80(%ebx),%eax
}
...
8010455a:	68 44 7b 10 80       	push   $0x80107b44
...
801045b5:	e8 d6 fa ff ff       	call   80104090 <sleep>
  while (lk->locked) {
...
801045c3:	c7 03 01 00 00 00    	movl   $0x1,(%ebx)
  lk->pid = myproc()->pid;
801045c9:	e8 d2 f3 ff ff       	call   801039a0 <myproc>
...
80104614:	e8 37 fb ff ff       	call   80104150 <wakeup>
  release(&lk->lk);
...
8010466b:	e8 30 f3 ff ff       	call   801039a0 <myproc>
...
8010472a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    mycpu()->intena = eflags & FL_IF;
80104730:	e8 eb f1 ff ff       	call   80103920 <mycpu>
...
8010475b:	75 35                	jne    80104792 <popcli+0x42>
  ...
  if(--mycpu()->ncli < 0)
8010475d:	e8 be f1 ff ff       	call   80103920 <mycpu>
...
8010477c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  if(mycpu()->ncli == 0 && mycpu()->intena)
80104780:	e8 9b f1 ff ff       	call   80103920 <mycpu>
...
80104795:	68 4f 7b 10 80       	push   $0x80107b4f
8010479a:	e8 e1 bb ff ff       	call   80100380 <panic>
    panic("popcli");
8010479f:	83 ec 0c             	sub    $0xc,%esp
801047a2:	68 66 7b 10 80       	push   $0x80107b66
...
801047d3:	e8 48 f1 ff ff       	call   80103920 <mycpu>
...
8010488c:	e8 8f f0 ff ff       	call   80103920 <mycpu>
...
80104900:	68 75 7b 10 80       	push   $0x80107b75
...
80104b47:	8b 5d 08             	mov    0x8(%ebp),%ebx
  struct proc *curproc = myproc();
80104b4a:	e8 51 ee ff ff       	call   801039a0 <myproc>
...
80104b87:	8b 5d 08             	mov    0x8(%ebp),%ebx
  char *s, *ep;
  struct proc *curproc = myproc();
80104b8a:	e8 11 ee ff ff       	call   801039a0 <myproc>
...
80104bd5:	e8 c6 ed ff ff       	call   801039a0 <myproc>
...
80104be3:	8d 1c 90             	lea    (%eax,%edx,4),%ebx
  struct proc *curproc = myproc();
80104be6:	e8 b5 ed ff ff       	call   801039a0 <myproc>
  return fetchint((myproc()->tf->esp) + 4 + 4*n, ip);
...
80104c26:	83 ec 0c             	sub    $0xc,%esp
  int i;
  struct proc *curproc = myproc();
80104c29:	e8 72 ed ff ff       	call   801039a0 <myproc>
80104c2e:	89 c6                	mov    %eax,%esi
  return fetchint((myproc()->tf->esp) + 4 + 4*n, ip);
80104c30:	e8 6b ed ff ff       	call   801039a0 <myproc>
...
80104c3e:	8d 1c 90             	lea    (%eax,%edx,4),%ebx
  struct proc *curproc = myproc();
80104c41:	e8 5a ed ff ff       	call   801039a0 <myproc>
  return fetchint((myproc()->tf->esp) + 4 + 4*n, ip);
...
80104c94:	53                   	push   %ebx
  return fetchint((myproc()->tf->esp) + 4 + 4*n, ip);
80104c95:	e8 06 ed ff ff       	call   801039a0 <myproc>
...
80104ca3:	8d 1c 90             	lea    (%eax,%edx,4),%ebx
  struct proc *curproc = myproc();
80104ca6:	e8 f5 ec ff ff       	call   801039a0 <myproc>
  return fetchint((myproc()->tf->esp) + 4 + 4*n, ip);
...
80104cbb:	8b 5b 04             	mov    0x4(%ebx),%ebx
  struct proc *curproc = myproc();
80104cbe:	e8 dd ec ff ff       	call   801039a0 <myproc>
  if(addr >= curproc->sz)
...
80104d14:	83 ec 04             	sub    $0x4,%esp
  int num;
  struct proc *curproc = myproc();
80104d17:	e8 84 ec ff ff       	call   801039a0 <myproc>
...
80104d27:	83 fa 19             	cmp    $0x19,%edx
80104d2a:	77 24                	ja     80104d50 <syscall+0x40>
80104d2c:	8b 14 85 a0 7b 10 80 	mov    -0x7fef8460(,%eax,4),%edx
...
80104d58:	68 7d 7b 10 80       	push   $0x80107b7d
...
80104eb4:	68 28 7c 10 80       	push   $0x80107c28
...
80104ecc:	68 27 7c 10 80       	push   $0x80107c27
...
80104ee1:	68 1b 7c 10 80       	push   $0x80107c1b
...
80104eff:	68 2a 7c 10 80       	push   $0x80107c2a
80104f04:	e8 77 b4 ff ff       	call   80100380 <panic>
    panic("create: ialloc");
80104f09:	83 ec 0c             	sub    $0xc,%esp
80104f0c:	68 0c 7c 10 80       	push   $0x80107c0c
...
80105040:	e8 5b e9 ff ff       	call   801039a0 <myproc>
...
801050c0:	e8 db e8 ff ff       	call   801039a0 <myproc>
...
801050d1:	74 25                	je     801050f8 <sys_close+0x58>
  myproc()->ofile[fd] = 0;
801050d3:	e8 c8 e8 ff ff       	call   801039a0 <myproc>
  fileclose(f);
...
80105120:	e8 7b e8 ff ff       	call   801039a0 <myproc>
...
8010530d:	58                   	pop    %eax
8010530e:	5a                   	pop    %edx
8010530f:	68 28 7c 10 80       	push   $0x80107c28
...
80105328:	68 27 7c 10 80       	push   $0x80107c27
...
801056d5:	83 ec 10             	sub    $0x10,%esp
  ...
  struct inode *ip;
  struct proc *curproc = myproc();
801056d8:	e8 c3 e2 ff ff       	call   801039a0 <myproc>
...
801058a7:	31 db                	xor    %ebx,%ebx
  struct proc *curproc = myproc();
801058a9:	e8 f2 e0 ff ff       	call   801039a0 <myproc>
  for(fd = 0; fd < NOFILE; fd++){
...
801058e7:	8b 7d e4             	mov    -0x1c(%ebp),%edi
  struct proc *curproc = myproc();
801058ea:	e8 b1 e0 ff ff       	call   801039a0 <myproc>
  for(fd = 0; fd < NOFILE; fd++){
...
80105906:	75 f0                	jne    801058f8 <sys_pipe+0x88>
      myproc()->ofile[fd0] = 0;
80105908:	e8 93 e0 ff ff       	call   801039a0 <myproc>
...
{
  return fork();
80105940:	e9 fb e1 ff ff       	jmp    80103b40 <fork>
...
80105953:	83 ec 08             	sub    $0x8,%esp
  exit();
80105956:	e8 85 e4 ff ff       	call   80103de0 <exit>
...
{
  return wait();
80105960:	e9 ab e5 ff ff       	jmp    80103f10 <wait>
...
8010598e:	e8 1d e8 ff ff       	call   801041b0 <kill>
...
801059b3:	83 ec 08             	sub    $0x8,%esp
  return myproc()->pid;
801059b6:	e8 e5 df ff ff       	call   801039a0 <myproc>
...
801059e6:	e8 d5 e0 ff ff       	call   80103ac0 <growproc>
...
80105a30:	68 80 3f 11 80       	push   $0x80113f80
80105a35:	e8 16 ee ff ff       	call   80104850 <acquire>
  ticks0 = ticks;
  while(ticks - ticks0 < n){
80105a3a:	8b 55 f4             	mov    -0xc(%ebp),%edx
  ticks0 = ticks;
80105a3d:	8b 1d 60 3f 11 80    	mov    0x80113f60,%ebx
  while(ticks - ticks0 < n){
...
80105a53:	68 80 3f 11 80       	push   $0x80113f80
80105a58:	68 60 3f 11 80       	push   $0x80113f60
80105a5d:	e8 2e e6 ff ff       	call   80104090 <sleep>
  while(ticks - ticks0 < n){
80105a62:	a1 60 3f 11 80       	mov    0x80113f60,%eax
...
80105a6f:	73 2f                	jae    80105aa0 <sys_sleep+0x90>
    if(myproc()->killed){
80105a71:	e8 2a df ff ff       	call   801039a0 <myproc>
...
80105a80:	68 80 3f 11 80       	push   $0x80113f80
...
80105aa3:	68 80 3f 11 80       	push   $0x80113f80
...
80105ac4:	83 ec 10             	sub    $0x10,%esp
  ...
  acquire(&tickslock);
80105ac7:	68 80 3f 11 80       	push   $0x80113f80
80105acc:	e8 7f ed ff ff       	call   80104850 <acquire>
  xticks = ticks;
80105ad1:	8b 1d 60 3f 11 80    	mov    0x80113f60,%ebx
  release(&tickslock);
80105ad7:	c7 04 24 80 3f 11 80 	movl   $0x80113f80,(%esp)
...
80105b60 <sys_getprio>:



int sys_getprio (void) {
  return getprio();
80105b60:	e9 bb e9 ff ff       	jmp    80104520 <getprio>
...
80105ba7:	c7 04 c5 c2 3f 11 80 	movl   $0x8e000008,-0x7feec03e(,%eax,8)
80105bae:	08 00 00 8e 
80105bb2:	66 89 14 c5 c0 3f 11 	mov    %dx,-0x7feec040(,%eax,8)
80105bb9:	80 
80105bba:	c1 ea 10             	shr    $0x10,%edx
80105bbd:	66 89 14 c5 c6 3f 11 	mov    %dx,-0x7feec03a(,%eax,8)
80105bc4:	80 
  for(i = 0; i < 256; i++)
...
80105bd7:	c7 05 c2 41 11 80 08 	movl   $0xef000008,0x801141c2
80105bde:	00 00 ef 
  initlock(&tickslock, "time");
80105be1:	68 6d 7c 10 80       	push   $0x80107c6d
80105be6:	68 80 3f 11 80       	push   $0x80113f80
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
80105beb:	66 a3 c0 41 11 80    	mov    %ax,0x801141c0
80105bf1:	c1 e8 10             	shr    $0x10,%eax
80105bf4:	66 a3 c6 41 11 80    	mov    %ax,0x801141c6
  initlock(&tickslock, "time");
...
80105c1b:	66 89 45 fa          	mov    %ax,-0x6(%ebp)
  pd[1] = (uint)p;
80105c1f:	b8 c0 3f 11 80       	mov    $0x80113fc0,%eax
...
80105c52:	0f 84 80 01 00 00    	je     80105dd8 <trap+0x198>
    if(myproc()->killed)
      exit();
    return;
  }
...
80105c64:	ff 24 85 14 7d 10 80 	jmp    *-0x7fef82ec(,%eax,4)
...
80105c7a:	e8 21 dd ff ff       	call   801039a0 <myproc>
80105c7f:	85 c0                	test   %eax,%eax
80105c81:	74 1d                	je     80105ca0 <trap+0x60>
80105c83:	e8 18 dd ff ff       	call   801039a0 <myproc>
...
80105c9a:	0f 84 00 02 00 00    	je     80105ea0 <trap+0x260>
    exit();

  // Force process to give up CPU on clock tick.
  // If interrupts were on while locks held, would need to check nlock.
  if(myproc() && myproc()->state == RUNNING &&
80105ca0:	e8 fb dc ff ff       	call   801039a0 <myproc>
...
80105cb2:	0f 84 b8 00 00 00    	je     80105d70 <trap+0x130>
  ...
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105cb8:	e8 e3 dc ff ff       	call   801039a0 <myproc>
80105cbd:	85 c0                	test   %eax,%eax
80105cbf:	74 1d                	je     80105cde <trap+0x9e>
80105cc1:	e8 da dc ff ff       	call   801039a0 <myproc>
...
80105cd8:	0f 84 27 01 00 00    	je     80105e05 <trap+0x1c5>
    exit();
}
...
80105cf0:	e8 ab dc ff ff       	call   801039a0 <myproc>
80105cf5:	8b 7b 38             	mov    0x38(%ebx),%edi
80105cf8:	85 c0                	test   %eax,%eax
80105cfa:	0f 84 ba 01 00 00    	je     80105eba <trap+0x27a>
80105d00:	f6 43 3c 03          	testb  $0x3,0x3c(%ebx)
80105d04:	0f 84 b0 01 00 00    	je     80105eba <trap+0x27a>
...
80105d10:	e8 6b dc ff ff       	call   80103980 <cpuid>
...
80105d45:	68 d0 7c 10 80       	push   $0x80107cd0
80105d4a:	e8 51 a9 ff ff       	call   801006a0 <cprintf>
    myproc()->killed = 1;
80105d4f:	83 c4 20             	add    $0x20,%esp
80105d52:	e8 49 dc ff ff       	call   801039a0 <myproc>
80105d57:	c7 40 24 01 00 00 00 	movl   $0x1,0x24(%eax)
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105d5e:	e8 3d dc ff ff       	call   801039a0 <myproc>
...
80105d7a:	e8 21 dc ff ff       	call   801039a0 <myproc>
    if (currProcTimerTicks == 0) {
80105d7f:	83 b8 84 00 00 00 01 	cmpl   $0x1,0x84(%eax)
80105d86:	0f 85 2c ff ff ff    	jne    80105cb8 <trap+0x78>
      yield();
80105d8c:	e8 af e2 ff ff       	call   80104040 <yield>
80105d91:	e9 22 ff ff ff       	jmp    80105cb8 <trap+0x78>
80105d96:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
80105d9d:	8d 76 00             	lea    0x0(%esi),%esi
    cprintf("cpu%d: spurious interrupt at %x:%x\n",
80105da0:	8b 7b 38             	mov    0x38(%ebx),%edi
80105da3:	0f b7 73 3c          	movzwl 0x3c(%ebx),%esi
80105da7:	e8 d4 db ff ff       	call   80103980 <cpuid>
80105dac:	57                   	push   %edi
80105dad:	56                   	push   %esi
80105dae:	50                   	push   %eax
80105daf:	68 78 7c 10 80       	push   $0x80107c78
80105db4:	e8 e7 a8 ff ff       	call   801006a0 <cprintf>
    lapiceoi();
80105db9:	e8 52 cb ff ff       	call   80102910 <lapiceoi>
    break;
80105dbe:	83 c4 10             	add    $0x10,%esp
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105dc1:	e8 da db ff ff       	call   801039a0 <myproc>
80105dc6:	85 c0                	test   %eax,%eax
80105dc8:	0f 85 b5 fe ff ff    	jne    80105c83 <trap+0x43>
80105dce:	e9 cd fe ff ff       	jmp    80105ca0 <trap+0x60>
80105dd3:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
80105dd7:	90                   	nop
    if(myproc()->killed)
80105dd8:	e8 c3 db ff ff       	call   801039a0 <myproc>
80105ddd:	8b 70 24             	mov    0x24(%eax),%esi
80105de0:	85 f6                	test   %esi,%esi
80105de2:	0f 85 c8 00 00 00    	jne    80105eb0 <trap+0x270>
    myproc()->tf = tf;
80105de8:	e8 b3 db ff ff       	call   801039a0 <myproc>
80105ded:	89 58 18             	mov    %ebx,0x18(%eax)
    syscall();
80105df0:	e8 1b ef ff ff       	call   80104d10 <syscall>
    if(myproc()->killed)
80105df5:	e8 a6 db ff ff       	call   801039a0 <myproc>
80105dfa:	8b 48 24             	mov    0x24(%eax),%ecx
80105dfd:	85 c9                	test   %ecx,%ecx
80105dff:	0f 84 d9 fe ff ff    	je     80105cde <trap+0x9e>
}
...
80105e0b:	5d                   	pop    %ebp
      exit();
80105e0c:	e9 cf df ff ff       	jmp    80103de0 <exit>
80105e11:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    uartintr();
80105e18:	e8 43 02 00 00       	call   80106060 <uartintr>
    lapiceoi();
80105e1d:	e8 ee ca ff ff       	call   80102910 <lapiceoi>
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105e22:	e8 79 db ff ff       	call   801039a0 <myproc>
80105e27:	85 c0                	test   %eax,%eax
80105e29:	0f 85 54 fe ff ff    	jne    80105c83 <trap+0x43>
80105e2f:	e9 6c fe ff ff       	jmp    80105ca0 <trap+0x60>
80105e34:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    kbdintr();
80105e38:	e8 93 c9 ff ff       	call   801027d0 <kbdintr>
    lapiceoi();
80105e3d:	e8 ce ca ff ff       	call   80102910 <lapiceoi>
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105e42:	e8 59 db ff ff       	call   801039a0 <myproc>
80105e47:	85 c0                	test   %eax,%eax
80105e49:	0f 85 34 fe ff ff    	jne    80105c83 <trap+0x43>
80105e4f:	e9 4c fe ff ff       	jmp    80105ca0 <trap+0x60>
80105e54:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    if(cpuid() == 0){
80105e58:	e8 23 db ff ff       	call   80103980 <cpuid>
80105e5d:	85 c0                	test   %eax,%eax
80105e5f:	0f 85 10 fe ff ff    	jne    80105c75 <trap+0x35>
      acquire(&tickslock);
80105e65:	83 ec 0c             	sub    $0xc,%esp
80105e68:	68 80 3f 11 80       	push   $0x80113f80
80105e6d:	e8 de e9 ff ff       	call   80104850 <acquire>
      wakeup(&ticks);
80105e72:	c7 04 24 60 3f 11 80 	movl   $0x80113f60,(%esp)
      ticks++;
80105e79:	83 05 60 3f 11 80 01 	addl   $0x1,0x80113f60
      wakeup(&ticks);
80105e80:	e8 cb e2 ff ff       	call   80104150 <wakeup>
      release(&tickslock);
80105e85:	c7 04 24 80 3f 11 80 	movl   $0x80113f80,(%esp)
80105e8c:	e8 5f e9 ff ff       	call   801047f0 <release>
80105e91:	83 c4 10             	add    $0x10,%esp
    lapiceoi();
80105e94:	e9 dc fd ff ff       	jmp    80105c75 <trap+0x35>
80105e99:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    exit();
80105ea0:	e8 3b df ff ff       	call   80103de0 <exit>
80105ea5:	e9 f6 fd ff ff       	jmp    80105ca0 <trap+0x60>
80105eaa:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
      exit();
80105eb0:	e8 2b df ff ff       	call   80103de0 <exit>
80105eb5:	e9 2e ff ff ff       	jmp    80105de8 <trap+0x1a8>
80105eba:	0f 20 d6             	mov    %cr2,%esi
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
80105ebd:	e8 be da ff ff       	call   80103980 <cpuid>
80105ec2:	83 ec 0c             	sub    $0xc,%esp
80105ec5:	56                   	push   %esi
80105ec6:	57                   	push   %edi
80105ec7:	50                   	push   %eax
80105ec8:	ff 73 30             	push   0x30(%ebx)
80105ecb:	68 9c 7c 10 80       	push   $0x80107c9c
80105ed0:	e8 cb a7 ff ff       	call   801006a0 <cprintf>
      panic("trap");
80105ed5:	83 c4 14             	add    $0x14,%esp
80105ed8:	68 72 7c 10 80       	push   $0x80107c72
...
{
  if(!uart)
80105ef0:	a1 c0 47 11 80       	mov    0x801147c0,%eax
...
80105f77:	74 78                	je     80105ff1 <uartinit+0xd1>
  uart = 1;
80105f79:	c7 05 c0 47 11 80 01 	movl   $0x1,0x801147c0
80105f80:	00 00 00 
...
80105f8c:	83 ec 08             	sub    $0x8,%esp
  for(p="xv6...\n"; *p; p++)
80105f8f:	bf 94 7d 10 80       	mov    $0x80107d94,%edi
...
80105fa9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
  if(!uart)
80105fb0:	a1 c0 47 11 80       	mov    0x801147c0,%eax
...
80106000 <uartputc>:
  if(!uart)
80106000:	a1 c0 47 11 80       	mov    0x801147c0,%eax
...
80106077:	6a 00                	push   $0x0
  jmp alltraps
80106079:	e9 e7 fa ff ff       	jmp    80105b65 <alltraps>
...
80106080:	6a 01                	push   $0x1
  jmp alltraps
80106082:	e9 de fa ff ff       	jmp    80105b65 <alltraps>
...
80106089:	6a 02                	push   $0x2
  jmp alltraps
8010608b:	e9 d5 fa ff ff       	jmp    80105b65 <alltraps>
...
80106092:	6a 03                	push   $0x3
  jmp alltraps
80106094:	e9 cc fa ff ff       	jmp    80105b65 <alltraps>
...
8010609b:	6a 04                	push   $0x4
  jmp alltraps
8010609d:	e9 c3 fa ff ff       	jmp    80105b65 <alltraps>
...
801060a4:	6a 05                	push   $0x5
  jmp alltraps
801060a6:	e9 ba fa ff ff       	jmp    80105b65 <alltraps>
...
801060ad:	6a 06                	push   $0x6
  jmp alltraps
801060af:	e9 b1 fa ff ff       	jmp    80105b65 <alltraps>
...
801060b6:	6a 07                	push   $0x7
  jmp alltraps
801060b8:	e9 a8 fa ff ff       	jmp    80105b65 <alltraps>
...
801060bd:	6a 08                	push   $0x8
  jmp alltraps
801060bf:	e9 a1 fa ff ff       	jmp    80105b65 <alltraps>
...
801060c6:	6a 09                	push   $0x9
  jmp alltraps
801060c8:	e9 98 fa ff ff       	jmp    80105b65 <alltraps>
...
801060cd:	6a 0a                	push   $0xa
  jmp alltraps
801060cf:	e9 91 fa ff ff       	jmp    80105b65 <alltraps>
...
801060d4:	6a 0b                	push   $0xb
  jmp alltraps
801060d6:	e9 8a fa ff ff       	jmp    80105b65 <alltraps>
...
801060db:	6a 0c                	push   $0xc
  jmp alltraps
801060dd:	e9 83 fa ff ff       	jmp    80105b65 <alltraps>
...
801060e2:	6a 0d                	push   $0xd
  jmp alltraps
801060e4:	e9 7c fa ff ff       	jmp    80105b65 <alltraps>
...
801060e9:	6a 0e                	push   $0xe
  jmp alltraps
801060eb:	e9 75 fa ff ff       	jmp    80105b65 <alltraps>
...
801060f2:	6a 0f                	push   $0xf
  jmp alltraps
801060f4:	e9 6c fa ff ff       	jmp    80105b65 <alltraps>
...
801060fb:	6a 10                	push   $0x10
  jmp alltraps
801060fd:	e9 63 fa ff ff       	jmp    80105b65 <alltraps>
...
80106102:	6a 11                	push   $0x11
  jmp alltraps
80106104:	e9 5c fa ff ff       	jmp    80105b65 <alltraps>
...
8010610b:	6a 12                	push   $0x12
  jmp alltraps
8010610d:	e9 53 fa ff ff       	jmp    80105b65 <alltraps>
...
80106114:	6a 13                	push   $0x13
  jmp alltraps
80106116:	e9 4a fa ff ff       	jmp    80105b65 <alltraps>
...
8010611d:	6a 14                	push   $0x14
  jmp alltraps
8010611f:	e9 41 fa ff ff       	jmp    80105b65 <alltraps>
...
80106126:	6a 15                	push   $0x15
  jmp alltraps
80106128:	e9 38 fa ff ff       	jmp    80105b65 <alltraps>
...
8010612f:	6a 16                	push   $0x16
  jmp alltraps
80106131:	e9 2f fa ff ff       	jmp    80105b65 <alltraps>
...
80106138:	6a 17                	push   $0x17
  jmp alltraps
8010613a:	e9 26 fa ff ff       	jmp    80105b65 <alltraps>
...
80106141:	6a 18                	push   $0x18
  jmp alltraps
80106143:	e9 1d fa ff ff       	jmp    80105b65 <alltraps>
...
8010614a:	6a 19                	push   $0x19
  jmp alltraps
8010614c:	e9 14 fa ff ff       	jmp    80105b65 <alltraps>
...
80106153:	6a 1a                	push   $0x1a
  jmp alltraps
80106155:	e9 0b fa ff ff       	jmp    80105b65 <alltraps>
...
8010615c:	6a 1b                	push   $0x1b
  jmp alltraps
8010615e:	e9 02 fa ff ff       	jmp    80105b65 <alltraps>
...
80106165:	6a 1c                	push   $0x1c
  jmp alltraps
80106167:	e9 f9 f9 ff ff       	jmp    80105b65 <alltraps>
...
8010616e:	6a 1d                	push   $0x1d
  jmp alltraps
80106170:	e9 f0 f9 ff ff       	jmp    80105b65 <alltraps>
...
80106177:	6a 1e                	push   $0x1e
  jmp alltraps
80106179:	e9 e7 f9 ff ff       	jmp    80105b65 <alltraps>
...
80106180:	6a 1f                	push   $0x1f
  jmp alltraps
80106182:	e9 de f9 ff ff       	jmp    80105b65 <alltraps>
...
80106189:	6a 20                	push   $0x20
  jmp alltraps
8010618b:	e9 d5 f9 ff ff       	jmp    80105b65 <alltraps>
...
80106192:	6a 21                	push   $0x21
  jmp alltraps
80106194:	e9 cc f9 ff ff       	jmp    80105b65 <alltraps>
...
8010619b:	6a 22                	push   $0x22
  jmp alltraps
8010619d:	e9 c3 f9 ff ff       	jmp    80105b65 <alltraps>
...
801061a4:	6a 23                	push   $0x23
  jmp alltraps
801061a6:	e9 ba f9 ff ff       	jmp    80105b65 <alltraps>
...
801061ad:	6a 24                	push   $0x24
  jmp alltraps
801061af:	e9 b1 f9 ff ff       	jmp    80105b65 <alltraps>
...
801061b6:	6a 25                	push   $0x25
  jmp alltraps
801061b8:	e9 a8 f9 ff ff       	jmp    80105b65 <alltraps>
...
801061bf:	6a 26                	push   $0x26
  jmp alltraps
801061c1:	e9 9f f9 ff ff       	jmp    80105b65 <alltraps>
...
801061c8:	6a 27                	push   $0x27
  jmp alltraps
801061ca:	e9 96 f9 ff ff       	jmp    80105b65 <alltraps>
...
801061d1:	6a 28                	push   $0x28
  jmp alltraps
801061d3:	e9 8d f9 ff ff       	jmp    80105b65 <alltraps>
...
801061da:	6a 29                	push   $0x29
  jmp alltraps
801061dc:	e9 84 f9 ff ff       	jmp    80105b65 <alltraps>
...
801061e3:	6a 2a                	push   $0x2a
  jmp alltraps
801061e5:	e9 7b f9 ff ff       	jmp    80105b65 <alltraps>
...
801061ec:	6a 2b                	push   $0x2b
  jmp alltraps
801061ee:	e9 72 f9 ff ff       	jmp    80105b65 <alltraps>
...
801061f5:	6a 2c                	push   $0x2c
  jmp alltraps
801061f7:	e9 69 f9 ff ff       	jmp    80105b65 <alltraps>
...
801061fe:	6a 2d                	push   $0x2d
  jmp alltraps
80106200:	e9 60 f9 ff ff       	jmp    80105b65 <alltraps>
...
80106207:	6a 2e                	push   $0x2e
  jmp alltraps
80106209:	e9 57 f9 ff ff       	jmp    80105b65 <alltraps>
...
80106210:	6a 2f                	push   $0x2f
  jmp alltraps
80106212:	e9 4e f9 ff ff       	jmp    80105b65 <alltraps>
...
80106219:	6a 30                	push   $0x30
  jmp alltraps
8010621b:	e9 45 f9 ff ff       	jmp    80105b65 <alltraps>
...
80106222:	6a 31                	push   $0x31
  jmp alltraps
80106224:	e9 3c f9 ff ff       	jmp    80105b65 <alltraps>
...
8010622b:	6a 32                	push   $0x32
  jmp alltraps
8010622d:	e9 33 f9 ff ff       	jmp    80105b65 <alltraps>
...
80106234:	6a 33                	push   $0x33
  jmp alltraps
80106236:	e9 2a f9 ff ff       	jmp    80105b65 <alltraps>
...
8010623d:	6a 34                	push   $0x34
  jmp alltraps
8010623f:	e9 21 f9 ff ff       	jmp    80105b65 <alltraps>
...
80106246:	6a 35                	push   $0x35
  jmp alltraps
80106248:	e9 18 f9 ff ff       	jmp    80105b65 <alltraps>
...
8010624f:	6a 36                	push   $0x36
  jmp alltraps
80106251:	e9 0f f9 ff ff       	jmp    80105b65 <alltraps>
...
80106258:	6a 37                	push   $0x37
  jmp alltraps
8010625a:	e9 06 f9 ff ff       	jmp    80105b65 <alltraps>
...
80106261:	6a 38                	push   $0x38
  jmp alltraps
80106263:	e9 fd f8 ff ff       	jmp    80105b65 <alltraps>
...
8010626a:	6a 39                	push   $0x39
  jmp alltraps
8010626c:	e9 f4 f8 ff ff       	jmp    80105b65 <alltraps>
...
80106273:	6a 3a                	push   $0x3a
  jmp alltraps
80106275:	e9 eb f8 ff ff       	jmp    80105b65 <alltraps>
...
8010627c:	6a 3b                	push   $0x3b
  jmp alltraps
8010627e:	e9 e2 f8 ff ff       	jmp    80105b65 <alltraps>
...
80106285:	6a 3c                	push   $0x3c
  jmp alltraps
80106287:	e9 d9 f8 ff ff       	jmp    80105b65 <alltraps>
...
8010628e:	6a 3d                	push   $0x3d
  jmp alltraps
80106290:	e9 d0 f8 ff ff       	jmp    80105b65 <alltraps>
...
80106297:	6a 3e                	push   $0x3e
  jmp alltraps
80106299:	e9 c7 f8 ff ff       	jmp    80105b65 <alltraps>
...
801062a0:	6a 3f                	push   $0x3f
  jmp alltraps
801062a2:	e9 be f8 ff ff       	jmp    80105b65 <alltraps>
...
801062a9:	6a 40                	push   $0x40
  jmp alltraps
801062ab:	e9 b5 f8 ff ff       	jmp    80105b65 <alltraps>
...
801062b2:	6a 41                	push   $0x41
  jmp alltraps
801062b4:	e9 ac f8 ff ff       	jmp    80105b65 <alltraps>
...
801062bb:	6a 42                	push   $0x42
  jmp alltraps
801062bd:	e9 a3 f8 ff ff       	jmp    80105b65 <alltraps>
...
801062c4:	6a 43                	push   $0x43
  jmp alltraps
801062c6:	e9 9a f8 ff ff       	jmp    80105b65 <alltraps>
...
801062cd:	6a 44                	push   $0x44
  jmp alltraps
801062cf:	e9 91 f8 ff ff       	jmp    80105b65 <alltraps>
...
801062d6:	6a 45                	push   $0x45
  jmp alltraps
801062d8:	e9 88 f8 ff ff       	jmp    80105b65 <alltraps>
...
801062df:	6a 46                	push   $0x46
  jmp alltraps
801062e1:	e9 7f f8 ff ff       	jmp    80105b65 <alltraps>
...
801062e8:	6a 47                	push   $0x47
  jmp alltraps
801062ea:	e9 76 f8 ff ff       	jmp    80105b65 <alltraps>
...
801062f1:	6a 48                	push   $0x48
  jmp alltraps
801062f3:	e9 6d f8 ff ff       	jmp    80105b65 <alltraps>
...
801062fa:	6a 49                	push   $0x49
  jmp alltraps
801062fc:	e9 64 f8 ff ff       	jmp    80105b65 <alltraps>
...
80106303:	6a 4a                	push   $0x4a
  jmp alltraps
80106305:	e9 5b f8 ff ff       	jmp    80105b65 <alltraps>
...
8010630c:	6a 4b                	push   $0x4b
  jmp alltraps
8010630e:	e9 52 f8 ff ff       	jmp    80105b65 <alltraps>
...
80106315:	6a 4c                	push   $0x4c
  jmp alltraps
80106317:	e9 49 f8 ff ff       	jmp    80105b65 <alltraps>
...
8010631e:	6a 4d                	push   $0x4d
  jmp alltraps
80106320:	e9 40 f8 ff ff       	jmp    80105b65 <alltraps>
...
80106327:	6a 4e                	push   $0x4e
  jmp alltraps
80106329:	e9 37 f8 ff ff       	jmp    80105b65 <alltraps>
...
80106330:	6a 4f                	push   $0x4f
  jmp alltraps
80106332:	e9 2e f8 ff ff       	jmp    80105b65 <alltraps>
...
80106339:	6a 50                	push   $0x50
  jmp alltraps
8010633b:	e9 25 f8 ff ff       	jmp    80105b65 <alltraps>
...
80106342:	6a 51                	push   $0x51
  jmp alltraps
80106344:	e9 1c f8 ff ff       	jmp    80105b65 <alltraps>
...
8010634b:	6a 52                	push   $0x52
  jmp alltraps
8010634d:	e9 13 f8 ff ff       	jmp    80105b65 <alltraps>
...
80106354:	6a 53                	push   $0x53
  jmp alltraps
80106356:	e9 0a f8 ff ff       	jmp    80105b65 <alltraps>
...
8010635d:	6a 54                	push   $0x54
  jmp alltraps
8010635f:	e9 01 f8 ff ff       	jmp    80105b65 <alltraps>
...
80106366:	6a 55                	push   $0x55
  jmp alltraps
80106368:	e9 f8 f7 ff ff       	jmp    80105b65 <alltraps>
...
8010636f:	6a 56                	push   $0x56
  jmp alltraps
80106371:	e9 ef f7 ff ff       	jmp    80105b65 <alltraps>
...
80106378:	6a 57                	push   $0x57
  jmp alltraps
8010637a:	e9 e6 f7 ff ff       	jmp    80105b65 <alltraps>
...
80106381:	6a 58                	push   $0x58
  jmp alltraps
80106383:	e9 dd f7 ff ff       	jmp    80105b65 <alltraps>
...
8010638a:	6a 59                	push   $0x59
  jmp alltraps
8010638c:	e9 d4 f7 ff ff       	jmp    80105b65 <alltraps>
...
80106393:	6a 5a                	push   $0x5a
  jmp alltraps
80106395:	e9 cb f7 ff ff       	jmp    80105b65 <alltraps>
...
8010639c:	6a 5b                	push   $0x5b
  jmp alltraps
8010639e:	e9 c2 f7 ff ff       	jmp    80105b65 <alltraps>
...
801063a5:	6a 5c                	push   $0x5c
  jmp alltraps
801063a7:	e9 b9 f7 ff ff       	jmp    80105b65 <alltraps>
...
801063ae:	6a 5d                	push   $0x5d
  jmp alltraps
801063b0:	e9 b0 f7 ff ff       	jmp    80105b65 <alltraps>
...
801063b7:	6a 5e                	push   $0x5e
  jmp alltraps
801063b9:	e9 a7 f7 ff ff       	jmp    80105b65 <alltraps>
...
801063c0:	6a 5f                	push   $0x5f
  jmp alltraps
801063c2:	e9 9e f7 ff ff       	jmp    80105b65 <alltraps>
...
801063c9:	6a 60                	push   $0x60
  jmp alltraps
801063cb:	e9 95 f7 ff ff       	jmp    80105b65 <alltraps>
...
801063d2:	6a 61                	push   $0x61
  jmp alltraps
801063d4:	e9 8c f7 ff ff       	jmp    80105b65 <alltraps>
...
801063db:	6a 62                	push   $0x62
  jmp alltraps
801063dd:	e9 83 f7 ff ff       	jmp    80105b65 <alltraps>
...
801063e4:	6a 63                	push   $0x63
  jmp alltraps
801063e6:	e9 7a f7 ff ff       	jmp    80105b65 <alltraps>
...
801063ed:	6a 64                	push   $0x64
  jmp alltraps
801063ef:	e9 71 f7 ff ff       	jmp    80105b65 <alltraps>
...
801063f6:	6a 65                	push   $0x65
  jmp alltraps
801063f8:	e9 68 f7 ff ff       	jmp    80105b65 <alltraps>
...
801063ff:	6a 66                	push   $0x66
  jmp alltraps
80106401:	e9 5f f7 ff ff       	jmp    80105b65 <alltraps>
...
80106408:	6a 67                	push   $0x67
  jmp alltraps
8010640a:	e9 56 f7 ff ff       	jmp    80105b65 <alltraps>
...
80106411:	6a 68                	push   $0x68
  jmp alltraps
80106413:	e9 4d f7 ff ff       	jmp    80105b65 <alltraps>
...
8010641a:	6a 69                	push   $0x69
  jmp alltraps
8010641c:	e9 44 f7 ff ff       	jmp    80105b65 <alltraps>
...
80106423:	6a 6a                	push   $0x6a
  jmp alltraps
80106425:	e9 3b f7 ff ff       	jmp    80105b65 <alltraps>
...
8010642c:	6a 6b                	push   $0x6b
  jmp alltraps
8010642e:	e9 32 f7 ff ff       	jmp    80105b65 <alltraps>
...
80106435:	6a 6c                	push   $0x6c
  jmp alltraps
80106437:	e9 29 f7 ff ff       	jmp    80105b65 <alltraps>
...
8010643e:	6a 6d                	push   $0x6d
  jmp alltraps
80106440:	e9 20 f7 ff ff       	jmp    80105b65 <alltraps>
...
80106447:	6a 6e                	push   $0x6e
  jmp alltraps
80106449:	e9 17 f7 ff ff       	jmp    80105b65 <alltraps>
...
80106450:	6a 6f                	push   $0x6f
  jmp alltraps
80106452:	e9 0e f7 ff ff       	jmp    80105b65 <alltraps>
...
80106459:	6a 70                	push   $0x70
  jmp alltraps
8010645b:	e9 05 f7 ff ff       	jmp    80105b65 <alltraps>
...
80106462:	6a 71                	push   $0x71
  jmp alltraps
80106464:	e9 fc f6 ff ff       	jmp    80105b65 <alltraps>
...
8010646b:	6a 72                	push   $0x72
  jmp alltraps
8010646d:	e9 f3 f6 ff ff       	jmp    80105b65 <alltraps>
...
80106474:	6a 73                	push   $0x73
  jmp alltraps
80106476:	e9 ea f6 ff ff       	jmp    80105b65 <alltraps>
...
8010647d:	6a 74                	push   $0x74
  jmp alltraps
8010647f:	e9 e1 f6 ff ff       	jmp    80105b65 <alltraps>
...
80106486:	6a 75                	push   $0x75
  jmp alltraps
80106488:	e9 d8 f6 ff ff       	jmp    80105b65 <alltraps>
...
8010648f:	6a 76                	push   $0x76
  jmp alltraps
80106491:	e9 cf f6 ff ff       	jmp    80105b65 <alltraps>
...
80106498:	6a 77                	push   $0x77
  jmp alltraps
8010649a:	e9 c6 f6 ff ff       	jmp    80105b65 <alltraps>
...
801064a1:	6a 78                	push   $0x78
  jmp alltraps
801064a3:	e9 bd f6 ff ff       	jmp    80105b65 <alltraps>
...
801064aa:	6a 79                	push   $0x79
  jmp alltraps
801064ac:	e9 b4 f6 ff ff       	jmp    80105b65 <alltraps>
...
801064b3:	6a 7a                	push   $0x7a
  jmp alltraps
801064b5:	e9 ab f6 ff ff       	jmp    80105b65 <alltraps>
...
801064bc:	6a 7b                	push   $0x7b
  jmp alltraps
801064be:	e9 a2 f6 ff ff       	jmp    80105b65 <alltraps>
...
801064c5:	6a 7c                	push   $0x7c
  jmp alltraps
801064c7:	e9 99 f6 ff ff       	jmp    80105b65 <alltraps>
...
801064ce:	6a 7d                	push   $0x7d
  jmp alltraps
801064d0:	e9 90 f6 ff ff       	jmp    80105b65 <alltraps>
...
801064d7:	6a 7e                	push   $0x7e
  jmp alltraps
801064d9:	e9 87 f6 ff ff       	jmp    80105b65 <alltraps>
...
801064e0:	6a 7f                	push   $0x7f
  jmp alltraps
801064e2:	e9 7e f6 ff ff       	jmp    80105b65 <alltraps>
...
801064e9:	68 80 00 00 00       	push   $0x80
  jmp alltraps
801064ee:	e9 72 f6 ff ff       	jmp    80105b65 <alltraps>
...
801064f5:	68 81 00 00 00       	push   $0x81
  jmp alltraps
801064fa:	e9 66 f6 ff ff       	jmp    80105b65 <alltraps>
...
80106501:	68 82 00 00 00       	push   $0x82
  jmp alltraps
80106506:	e9 5a f6 ff ff       	jmp    80105b65 <alltraps>
...
8010650d:	68 83 00 00 00       	push   $0x83
  jmp alltraps
80106512:	e9 4e f6 ff ff       	jmp    80105b65 <alltraps>
...
80106519:	68 84 00 00 00       	push   $0x84
  jmp alltraps
8010651e:	e9 42 f6 ff ff       	jmp    80105b65 <alltraps>
...
80106525:	68 85 00 00 00       	push   $0x85
  jmp alltraps
8010652a:	e9 36 f6 ff ff       	jmp    80105b65 <alltraps>
...
80106531:	68 86 00 00 00       	push   $0x86
  jmp alltraps
80106536:	e9 2a f6 ff ff       	jmp    80105b65 <alltraps>
...
8010653d:	68 87 00 00 00       	push   $0x87
  jmp alltraps
80106542:	e9 1e f6 ff ff       	jmp    80105b65 <alltraps>
...
80106549:	68 88 00 00 00       	push   $0x88
  jmp alltraps
8010654e:	e9 12 f6 ff ff       	jmp    80105b65 <alltraps>
...
80106555:	68 89 00 00 00       	push   $0x89
  jmp alltraps
8010655a:	e9 06 f6 ff ff       	jmp    80105b65 <alltraps>
...
80106561:	68 8a 00 00 00       	push   $0x8a
  jmp alltraps
80106566:	e9 fa f5 ff ff       	jmp    80105b65 <alltraps>
...
8010656d:	68 8b 00 00 00       	push   $0x8b
  jmp alltraps
80106572:	e9 ee f5 ff ff       	jmp    80105b65 <alltraps>
...
80106579:	68 8c 00 00 00       	push   $0x8c
  jmp alltraps
8010657e:	e9 e2 f5 ff ff       	jmp    80105b65 <alltraps>
...
80106585:	68 8d 00 00 00       	push   $0x8d
  jmp alltraps
8010658a:	e9 d6 f5 ff ff       	jmp    80105b65 <alltraps>
...
80106591:	68 8e 00 00 00       	push   $0x8e
  jmp alltraps
80106596:	e9 ca f5 ff ff       	jmp    80105b65 <alltraps>
...
8010659d:	68 8f 00 00 00       	push   $0x8f
  jmp alltraps
801065a2:	e9 be f5 ff ff       	jmp    80105b65 <alltraps>
...
801065a9:	68 90 00 00 00       	push   $0x90
  jmp alltraps
801065ae:	e9 b2 f5 ff ff       	jmp    80105b65 <alltraps>
...
801065b5:	68 91 00 00 00       	push   $0x91
  jmp alltraps
801065ba:	e9 a6 f5 ff ff       	jmp    80105b65 <alltraps>
...
801065c1:	68 92 00 00 00       	push   $0x92
  jmp alltraps
801065c6:	e9 9a f5 ff ff       	jmp    80105b65 <alltraps>
...
801065cd:	68 93 00 00 00       	push   $0x93
  jmp alltraps
801065d2:	e9 8e f5 ff ff       	jmp    80105b65 <alltraps>
...
801065d9:	68 94 00 00 00       	push   $0x94
  jmp alltraps
801065de:	e9 82 f5 ff ff       	jmp    80105b65 <alltraps>
...
801065e5:	68 95 00 00 00       	push   $0x95
  jmp alltraps
801065ea:	e9 76 f5 ff ff       	jmp    80105b65 <alltraps>
...
801065f1:	68 96 00 00 00       	push   $0x96
  jmp alltraps
801065f6:	e9 6a f5 ff ff       	jmp    80105b65 <alltraps>
...
801065fd:	68 97 00 00 00       	push   $0x97
  jmp alltraps
80106602:	e9 5e f5 ff ff       	jmp    80105b65 <alltraps>
...
80106609:	68 98 00 00 00       	push   $0x98
  jmp alltraps
8010660e:	e9 52 f5 ff ff       	jmp    80105b65 <alltraps>
...
80106615:	68 99 00 00 00       	push   $0x99
  jmp alltraps
8010661a:	e9 46 f5 ff ff       	jmp    80105b65 <alltraps>
...
80106621:	68 9a 00 00 00       	push   $0x9a
  jmp alltraps
80106626:	e9 3a f5 ff ff       	jmp    80105b65 <alltraps>
...
8010662d:	68 9b 00 00 00       	push   $0x9b
  jmp alltraps
80106632:	e9 2e f5 ff ff       	jmp    80105b65 <alltraps>
...
80106639:	68 9c 00 00 00       	push   $0x9c
  jmp alltraps
8010663e:	e9 22 f5 ff ff       	jmp    80105b65 <alltraps>
...
80106645:	68 9d 00 00 00       	push   $0x9d
  jmp alltraps
8010664a:	e9 16 f5 ff ff       	jmp    80105b65 <alltraps>
...
80106651:	68 9e 00 00 00       	push   $0x9e
  jmp alltraps
80106656:	e9 0a f5 ff ff       	jmp    80105b65 <alltraps>
...
8010665d:	68 9f 00 00 00       	push   $0x9f
  jmp alltraps
80106662:	e9 fe f4 ff ff       	jmp    80105b65 <alltraps>
...
80106669:	68 a0 00 00 00       	push   $0xa0
  jmp alltraps
8010666e:	e9 f2 f4 ff ff       	jmp    80105b65 <alltraps>
...
80106675:	68 a1 00 00 00       	push   $0xa1
  jmp alltraps
8010667a:	e9 e6 f4 ff ff       	jmp    80105b65 <alltraps>
...
80106681:	68 a2 00 00 00       	push   $0xa2
  jmp alltraps
80106686:	e9 da f4 ff ff       	jmp    80105b65 <alltraps>
...
8010668d:	68 a3 00 00 00       	push   $0xa3
  jmp alltraps
80106692:	e9 ce f4 ff ff       	jmp    80105b65 <alltraps>
...
80106699:	68 a4 00 00 00       	push   $0xa4
  jmp alltraps
8010669e:	e9 c2 f4 ff ff       	jmp    80105b65 <alltraps>
...
801066a5:	68 a5 00 00 00       	push   $0xa5
  jmp alltraps
801066aa:	e9 b6 f4 ff ff       	jmp    80105b65 <alltraps>
...
801066b1:	68 a6 00 00 00       	push   $0xa6
  jmp alltraps
801066b6:	e9 aa f4 ff ff       	jmp    80105b65 <alltraps>
...
801066bd:	68 a7 00 00 00       	push   $0xa7
  jmp alltraps
801066c2:	e9 9e f4 ff ff       	jmp    80105b65 <alltraps>
...
801066c9:	68 a8 00 00 00       	push   $0xa8
  jmp alltraps
801066ce:	e9 92 f4 ff ff       	jmp    80105b65 <alltraps>
...
801066d5:	68 a9 00 00 00       	push   $0xa9
  jmp alltraps
801066da:	e9 86 f4 ff ff       	jmp    80105b65 <alltraps>
...
801066e1:	68 aa 00 00 00       	push   $0xaa
  jmp alltraps
801066e6:	e9 7a f4 ff ff       	jmp    80105b65 <alltraps>
...
801066ed:	68 ab 00 00 00       	push   $0xab
  jmp alltraps
801066f2:	e9 6e f4 ff ff       	jmp    80105b65 <alltraps>
...
801066f9:	68 ac 00 00 00       	push   $0xac
  jmp alltraps
801066fe:	e9 62 f4 ff ff       	jmp    80105b65 <alltraps>
...
80106705:	68 ad 00 00 00       	push   $0xad
  jmp alltraps
8010670a:	e9 56 f4 ff ff       	jmp    80105b65 <alltraps>
...
80106711:	68 ae 00 00 00       	push   $0xae
  jmp alltraps
80106716:	e9 4a f4 ff ff       	jmp    80105b65 <alltraps>
...
8010671d:	68 af 00 00 00       	push   $0xaf
  jmp alltraps
80106722:	e9 3e f4 ff ff       	jmp    80105b65 <alltraps>
...
80106729:	68 b0 00 00 00       	push   $0xb0
  jmp alltraps
8010672e:	e9 32 f4 ff ff       	jmp    80105b65 <alltraps>
...
80106735:	68 b1 00 00 00       	push   $0xb1
  jmp alltraps
8010673a:	e9 26 f4 ff ff       	jmp    80105b65 <alltraps>
...
80106741:	68 b2 00 00 00       	push   $0xb2
  jmp alltraps
80106746:	e9 1a f4 ff ff       	jmp    80105b65 <alltraps>
...
8010674d:	68 b3 00 00 00       	push   $0xb3
  jmp alltraps
80106752:	e9 0e f4 ff ff       	jmp    80105b65 <alltraps>
...
80106759:	68 b4 00 00 00       	push   $0xb4
  jmp alltraps
8010675e:	e9 02 f4 ff ff       	jmp    80105b65 <alltraps>
...
80106765:	68 b5 00 00 00       	push   $0xb5
  jmp alltraps
8010676a:	e9 f6 f3 ff ff       	jmp    80105b65 <alltraps>
...
80106771:	68 b6 00 00 00       	push   $0xb6
  jmp alltraps
80106776:	e9 ea f3 ff ff       	jmp    80105b65 <alltraps>
...
8010677d:	68 b7 00 00 00       	push   $0xb7
  jmp alltraps
80106782:	e9 de f3 ff ff       	jmp    80105b65 <alltraps>
...
80106789:	68 b8 00 00 00       	push   $0xb8
  jmp alltraps
8010678e:	e9 d2 f3 ff ff       	jmp    80105b65 <alltraps>
...
80106795:	68 b9 00 00 00       	push   $0xb9
  jmp alltraps
8010679a:	e9 c6 f3 ff ff       	jmp    80105b65 <alltraps>
...
801067a1:	68 ba 00 00 00       	push   $0xba
  jmp alltraps
801067a6:	e9 ba f3 ff ff       	jmp    80105b65 <alltraps>
...
801067ad:	68 bb 00 00 00       	push   $0xbb
  jmp alltraps
801067b2:	e9 ae f3 ff ff       	jmp    80105b65 <alltraps>
...
801067b9:	68 bc 00 00 00       	push   $0xbc
  jmp alltraps
801067be:	e9 a2 f3 ff ff       	jmp    80105b65 <alltraps>
...
801067c5:	68 bd 00 00 00       	push   $0xbd
  jmp alltraps
801067ca:	e9 96 f3 ff ff       	jmp    80105b65 <alltraps>
...
801067d1:	68 be 00 00 00       	push   $0xbe
  jmp alltraps
801067d6:	e9 8a f3 ff ff       	jmp    80105b65 <alltraps>
...
801067dd:	68 bf 00 00 00       	push   $0xbf
  jmp alltraps
801067e2:	e9 7e f3 ff ff       	jmp    80105b65 <alltraps>
...
801067e9:	68 c0 00 00 00       	push   $0xc0
  jmp alltraps
801067ee:	e9 72 f3 ff ff       	jmp    80105b65 <alltraps>
...
801067f5:	68 c1 00 00 00       	push   $0xc1
  jmp alltraps
801067fa:	e9 66 f3 ff ff       	jmp    80105b65 <alltraps>
...
80106801:	68 c2 00 00 00       	push   $0xc2
  jmp alltraps
80106806:	e9 5a f3 ff ff       	jmp    80105b65 <alltraps>
...
8010680d:	68 c3 00 00 00       	push   $0xc3
  jmp alltraps
80106812:	e9 4e f3 ff ff       	jmp    80105b65 <alltraps>
...
80106819:	68 c4 00 00 00       	push   $0xc4
  jmp alltraps
8010681e:	e9 42 f3 ff ff       	jmp    80105b65 <alltraps>
...
80106825:	68 c5 00 00 00       	push   $0xc5
  jmp alltraps
8010682a:	e9 36 f3 ff ff       	jmp    80105b65 <alltraps>
...
80106831:	68 c6 00 00 00       	push   $0xc6
  jmp alltraps
80106836:	e9 2a f3 ff ff       	jmp    80105b65 <alltraps>
...
8010683d:	68 c7 00 00 00       	push   $0xc7
  jmp alltraps
80106842:	e9 1e f3 ff ff       	jmp    80105b65 <alltraps>
...
80106849:	68 c8 00 00 00       	push   $0xc8
  jmp alltraps
8010684e:	e9 12 f3 ff ff       	jmp    80105b65 <alltraps>
...
80106855:	68 c9 00 00 00       	push   $0xc9
  jmp alltraps
8010685a:	e9 06 f3 ff ff       	jmp    80105b65 <alltraps>
...
80106861:	68 ca 00 00 00       	push   $0xca
  jmp alltraps
80106866:	e9 fa f2 ff ff       	jmp    80105b65 <alltraps>
...
8010686d:	68 cb 00 00 00       	push   $0xcb
  jmp alltraps
80106872:	e9 ee f2 ff ff       	jmp    80105b65 <alltraps>
...
80106879:	68 cc 00 00 00       	push   $0xcc
  jmp alltraps
8010687e:	e9 e2 f2 ff ff       	jmp    80105b65 <alltraps>
...
80106885:	68 cd 00 00 00       	push   $0xcd
  jmp alltraps
8010688a:	e9 d6 f2 ff ff       	jmp    80105b65 <alltraps>
...
80106891:	68 ce 00 00 00       	push   $0xce
  jmp alltraps
80106896:	e9 ca f2 ff ff       	jmp    80105b65 <alltraps>
...
8010689d:	68 cf 00 00 00       	push   $0xcf
  jmp alltraps
801068a2:	e9 be f2 ff ff       	jmp    80105b65 <alltraps>
...
801068a9:	68 d0 00 00 00       	push   $0xd0
  jmp alltraps
801068ae:	e9 b2 f2 ff ff       	jmp    80105b65 <alltraps>
...
801068b5:	68 d1 00 00 00       	push   $0xd1
  jmp alltraps
801068ba:	e9 a6 f2 ff ff       	jmp    80105b65 <alltraps>
...
801068c1:	68 d2 00 00 00       	push   $0xd2
  jmp alltraps
801068c6:	e9 9a f2 ff ff       	jmp    80105b65 <alltraps>
...
801068cd:	68 d3 00 00 00       	push   $0xd3
  jmp alltraps
801068d2:	e9 8e f2 ff ff       	jmp    80105b65 <alltraps>
...
801068d9:	68 d4 00 00 00       	push   $0xd4
  jmp alltraps
801068de:	e9 82 f2 ff ff       	jmp    80105b65 <alltraps>
...
801068e5:	68 d5 00 00 00       	push   $0xd5
  jmp alltraps
801068ea:	e9 76 f2 ff ff       	jmp    80105b65 <alltraps>
...
801068f1:	68 d6 00 00 00       	push   $0xd6
  jmp alltraps
801068f6:	e9 6a f2 ff ff       	jmp    80105b65 <alltraps>
...
801068fd:	68 d7 00 00 00       	push   $0xd7
  jmp alltraps
80106902:	e9 5e f2 ff ff       	jmp    80105b65 <alltraps>
...
80106909:	68 d8 00 00 00       	push   $0xd8
  jmp alltraps
8010690e:	e9 52 f2 ff ff       	jmp    80105b65 <alltraps>
...
80106915:	68 d9 00 00 00       	push   $0xd9
  jmp alltraps
8010691a:	e9 46 f2 ff ff       	jmp    80105b65 <alltraps>
...
80106921:	68 da 00 00 00       	push   $0xda
  jmp alltraps
80106926:	e9 3a f2 ff ff       	jmp    80105b65 <alltraps>
...
8010692d:	68 db 00 00 00       	push   $0xdb
  jmp alltraps
80106932:	e9 2e f2 ff ff       	jmp    80105b65 <alltraps>
...
80106939:	68 dc 00 00 00       	push   $0xdc
  jmp alltraps
8010693e:	e9 22 f2 ff ff       	jmp    80105b65 <alltraps>
...
80106945:	68 dd 00 00 00       	push   $0xdd
  jmp alltraps
8010694a:	e9 16 f2 ff ff       	jmp    80105b65 <alltraps>
...
80106951:	68 de 00 00 00       	push   $0xde
  jmp alltraps
80106956:	e9 0a f2 ff ff       	jmp    80105b65 <alltraps>
...
8010695d:	68 df 00 00 00       	push   $0xdf
  jmp alltraps
80106962:	e9 fe f1 ff ff       	jmp    80105b65 <alltraps>
...
80106969:	68 e0 00 00 00       	push   $0xe0
  jmp alltraps
8010696e:	e9 f2 f1 ff ff       	jmp    80105b65 <alltraps>
...
80106975:	68 e1 00 00 00       	push   $0xe1
  jmp alltraps
8010697a:	e9 e6 f1 ff ff       	jmp    80105b65 <alltraps>
...
80106981:	68 e2 00 00 00       	push   $0xe2
  jmp alltraps
80106986:	e9 da f1 ff ff       	jmp    80105b65 <alltraps>
...
8010698d:	68 e3 00 00 00       	push   $0xe3
  jmp alltraps
80106992:	e9 ce f1 ff ff       	jmp    80105b65 <alltraps>
...
80106999:	68 e4 00 00 00       	push   $0xe4
  jmp alltraps
8010699e:	e9 c2 f1 ff ff       	jmp    80105b65 <alltraps>
...
801069a5:	68 e5 00 00 00       	push   $0xe5
  jmp alltraps
801069aa:	e9 b6 f1 ff ff       	jmp    80105b65 <alltraps>
...
801069b1:	68 e6 00 00 00       	push   $0xe6
  jmp alltraps
801069b6:	e9 aa f1 ff ff       	jmp    80105b65 <alltraps>
...
801069bd:	68 e7 00 00 00       	push   $0xe7
  jmp alltraps
801069c2:	e9 9e f1 ff ff       	jmp    80105b65 <alltraps>
...
801069c9:	68 e8 00 00 00       	push   $0xe8
  jmp alltraps
801069ce:	e9 92 f1 ff ff       	jmp    80105b65 <alltraps>
...
801069d5:	68 e9 00 00 00       	push   $0xe9
  jmp alltraps
801069da:	e9 86 f1 ff ff       	jmp    80105b65 <alltraps>
...
801069e1:	68 ea 00 00 00       	push   $0xea
  jmp alltraps
801069e6:	e9 7a f1 ff ff       	jmp    80105b65 <alltraps>
...
801069ed:	68 eb 00 00 00       	push   $0xeb
  jmp alltraps
801069f2:	e9 6e f1 ff ff       	jmp    80105b65 <alltraps>
...
801069f9:	68 ec 00 00 00       	push   $0xec
  jmp alltraps
801069fe:	e9 62 f1 ff ff       	jmp    80105b65 <alltraps>
...
80106a05:	68 ed 00 00 00       	push   $0xed
  jmp alltraps
80106a0a:	e9 56 f1 ff ff       	jmp    80105b65 <alltraps>
...
80106a11:	68 ee 00 00 00       	push   $0xee
  jmp alltraps
80106a16:	e9 4a f1 ff ff       	jmp    80105b65 <alltraps>
...
80106a1d:	68 ef 00 00 00       	push   $0xef
  jmp alltraps
80106a22:	e9 3e f1 ff ff       	jmp    80105b65 <alltraps>
...
80106a29:	68 f0 00 00 00       	push   $0xf0
  jmp alltraps
80106a2e:	e9 32 f1 ff ff       	jmp    80105b65 <alltraps>
...
80106a35:	68 f1 00 00 00       	push   $0xf1
  jmp alltraps
80106a3a:	e9 26 f1 ff ff       	jmp    80105b65 <alltraps>
...
80106a41:	68 f2 00 00 00       	push   $0xf2
  jmp alltraps
80106a46:	e9 1a f1 ff ff       	jmp    80105b65 <alltraps>
...
80106a4d:	68 f3 00 00 00       	push   $0xf3
  jmp alltraps
80106a52:	e9 0e f1 ff ff       	jmp    80105b65 <alltraps>
...
80106a59:	68 f4 00 00 00       	push   $0xf4
  jmp alltraps
80106a5e:	e9 02 f1 ff ff       	jmp    80105b65 <alltraps>
...
80106a65:	68 f5 00 00 00       	push   $0xf5
  jmp alltraps
80106a6a:	e9 f6 f0 ff ff       	jmp    80105b65 <alltraps>
...
80106a71:	68 f6 00 00 00       	push   $0xf6
  jmp alltraps
80106a76:	e9 ea f0 ff ff       	jmp    80105b65 <alltraps>
...
80106a7d:	68 f7 00 00 00       	push   $0xf7
  jmp alltraps
80106a82:	e9 de f0 ff ff       	jmp    80105b65 <alltraps>
...
80106a89:	68 f8 00 00 00       	push   $0xf8
  jmp alltraps
80106a8e:	e9 d2 f0 ff ff       	jmp    80105b65 <alltraps>
...
80106a95:	68 f9 00 00 00       	push   $0xf9
  jmp alltraps
80106a9a:	e9 c6 f0 ff ff       	jmp    80105b65 <alltraps>
...
80106aa1:	68 fa 00 00 00       	push   $0xfa
  jmp alltraps
80106aa6:	e9 ba f0 ff ff       	jmp    80105b65 <alltraps>
...
80106aad:	68 fb 00 00 00       	push   $0xfb
  jmp alltraps
80106ab2:	e9 ae f0 ff ff       	jmp    80105b65 <alltraps>
...
80106ab9:	68 fc 00 00 00       	push   $0xfc
  jmp alltraps
80106abe:	e9 a2 f0 ff ff       	jmp    80105b65 <alltraps>
...
80106ac5:	68 fd 00 00 00       	push   $0xfd
  jmp alltraps
80106aca:	e9 96 f0 ff ff       	jmp    80105b65 <alltraps>
...
80106ad1:	68 fe 00 00 00       	push   $0xfe
  jmp alltraps
80106ad6:	e9 8a f0 ff ff       	jmp    80105b65 <alltraps>
...
80106add:	68 ff 00 00 00       	push   $0xff
  jmp alltraps
80106ae2:	e9 7e f0 ff ff       	jmp    80105b65 <alltraps>
...
80106c7d:	68 9c 7d 10 80       	push   $0x80107d9c
...
80106c93:	83 ec 18             	sub    $0x18,%esp
  c = &cpus[cpuid()];
80106c96:	e8 e5 cc ff ff       	call   80103980 <cpuid>
  pd[0] = size-1;
...
80106d20:	a1 c4 47 11 80       	mov    0x801147c4,%eax
...
80106d54:	0f 84 c2 00 00 00    	je     80106e1c <switchuvm+0xec>
  pushcli();
80106d5a:	e8 a1 d9 ff ff       	call   80104700 <pushcli>
  mycpu()->gdt[SEG_TSS] = SEG16(STS_T32A, &mycpu()->ts,
80106d5f:	e8 bc cb ff ff       	call   80103920 <mycpu>
80106d64:	89 c3                	mov    %eax,%ebx
80106d66:	e8 b5 cb ff ff       	call   80103920 <mycpu>
80106d6b:	89 c7                	mov    %eax,%edi
80106d6d:	e8 ae cb ff ff       	call   80103920 <mycpu>
80106d72:	83 c7 08             	add    $0x8,%edi
80106d75:	89 45 e4             	mov    %eax,-0x1c(%ebp)
80106d78:	e8 a3 cb ff ff       	call   80103920 <mycpu>
...
80106eab:	68 e1 7d 10 80       	push   $0x80107de1
...
80106f10:	68 fb 7d 10 80       	push   $0x80107dfb
...
80106f98:	68 9c 7e 10 80       	push   $0x80107e9c
...
80107039:	68 19 7e 10 80       	push   $0x80107e19
...
8010709b:	68 31 7e 10 80       	push   $0x80107e31
...
8010717c:	68 4d 7e 10 80       	push   $0x80107e4d
...
8010721b:	a3 c4 47 11 80       	mov    %eax,0x801147c4
  lcr3(V2P(kpgdir));   // switch to the kernel page table
...
8010724c:	68 5e 7e 10 80       	push   $0x80107e5e
...
801072c2:	68 68 7e 10 80       	push   $0x80107e68
...
80107397:	68 82 7e 10 80       	push   $0x80107e82
...
80107450:	e8 5b d5 ff ff       	call   801049b0 <memmove>
    len -= n;
    buf += n;
