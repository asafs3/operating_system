...
{   
  ...
  7c:	8b 4d e4             	mov    -0x1c(%ebp),%ecx
    switch (state_idx)
  7f:	ba e8 07 00 00       	mov    $0x7e8,%edx
            printf(1,"%d\t%s  \t%d\t%d\t%d\t%d\t\n", pid, translate_state(info.state), info.ppid, info.sz, info.nfd, info.nrswitch);
  ...
  9b:	8b 14 85 8c 08 00 00 	mov    0x88c(,%eax,4),%edx
  a2:	51                   	push   %ecx
 ...
 41c:	89 d1                	mov    %edx,%ecx
{
 ...
 449:	0f b6 92 00 09 00 00 	movzbl 0x900(%edx),%edx
 ...
 4c9:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 539:	ff 24 85 a8 08 00 00 	jmp    *0x8a8(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 647:	90                   	nop
          s = "(null)";
 648:	ba a0 08 00 00       	mov    $0x8a0,%edx
        while(*s != 0){
