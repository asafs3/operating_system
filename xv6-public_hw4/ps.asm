...
{   
  ...
  14:	e8 ca 03 00 00       	call   3e3 <getNumProc>
  19:	89 c3                	mov    %eax,%ebx
    int maxPid = getMaxPid();
  1b:	e8 cb 03 00 00       	call   3eb <getMaxPid>
  ...
  55:	7e 6c                	jle    c3 <main+0xc3>
  57:	89 7d c4             	mov    %edi,-0x3c(%ebp)
  5a:	be 01 00 00 00       	mov    $0x1,%esi
  5f:	8d 5d d4             	lea    -0x2c(%ebp),%ebx
  ...
  6b:	53                   	push   %ebx
  6c:	56                   	push   %esi
  6d:	e8 81 03 00 00       	call   3f3 <getProcInfo>
  72:	83 c4 10             	add    $0x10,%esp
  75:	85 c0                	test   %eax,%eax
  77:	75 42                	jne    bb <main+0xbb>
            printf(1,"%d\t%s  \t%d\t%d\t%d\t%d\t\n", pid, translate_state(info.state), info.ppid, info.sz, info.nfd, info.nrswitch);
  79:	8b 45 e0             	mov    -0x20(%ebp),%eax
  7c:	8b 4d e4             	mov    -0x1c(%ebp),%ecx
    switch (state_idx)
  7f:	ba d8 07 00 00       	mov    $0x7d8,%edx
            printf(1,"%d\t%s  \t%d\t%d\t%d\t%d\t\n", pid, translate_state(info.state), info.ppid, info.sz, info.nfd, info.nrswitch);
  84:	8b 7d d8             	mov    -0x28(%ebp),%edi
  87:	89 45 c0             	mov    %eax,-0x40(%ebp)
  8a:	8b 45 dc             	mov    -0x24(%ebp),%eax
  8d:	89 45 bc             	mov    %eax,-0x44(%ebp)
  90:	8b 45 d4             	mov    -0x2c(%ebp),%eax
  93:	83 e8 01             	sub    $0x1,%eax
  96:	83 f8 04             	cmp    $0x4,%eax
  99:	77 07                	ja     a2 <main+0xa2>
  9b:	8b 14 85 7c 08 00 00 	mov    0x87c(,%eax,4),%edx
  a2:	51                   	push   %ecx
  a3:	ff 75 c0             	push   -0x40(%ebp)
  a6:	ff 75 bc             	push   -0x44(%ebp)
  a9:	57                   	push   %edi
  aa:	52                   	push   %edx
  ab:	56                   	push   %esi
  ac:	68 f1 07 00 00       	push   $0x7f1
  b1:	6a 01                	push   $0x1
  b3:	e8 f8 03 00 00       	call   4b0 <printf>
  b8:	83 c4 20             	add    $0x20,%esp
    for (int pid = 1 ; pid <= maxPid ; pid ++) {
  bb:	83 c6 01             	add    $0x1,%esi
  be:	39 75 c4             	cmp    %esi,-0x3c(%ebp)
  c1:	7d a5                	jge    68 <main+0x68>
        }  
  }
  exit();
...
000000d0 <translate_state>:
translate_state(int state_idx) {
  d0:	55                   	push   %ebp
  d1:	ba d8 07 00 00       	mov    $0x7d8,%edx
  d6:	89 e5                	mov    %esp,%ebp
  d8:	8b 45 08             	mov    0x8(%ebp),%eax
  db:	83 e8 01             	sub    $0x1,%eax
  de:	83 f8 04             	cmp    $0x4,%eax
  e1:	77 07                	ja     ea <translate_state+0x1a>
  e3:	8b 14 85 7c 08 00 00 	mov    0x87c(,%eax,4),%edx
}
 ...
 4b9:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 637:	90                   	nop
          s = "(null)";
 638:	ba 90 08 00 00       	mov    $0x890,%edx
        while(*s != 0){
...
free(void *ap)
{
 ...
 651:	a1 c4 0b 00 00       	mov    0xbc4,%eax
{
 ...
 691:	5b                   	pop    %ebx
  freep = p;
 692:	89 15 c4 0b 00 00    	mov    %edx,0xbc4
}
 698:	5e                   	pop    %esi
 699:	5f                   	pop    %edi
 69a:	5d                   	pop    %ebp
 ...
 6c9:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 6cc:	89 15 c4 0b 00 00    	mov    %edx,0xbc4
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 6e9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6ec:	8b 3d c4 0b 00 00    	mov    0xbc4,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 72f:	73 4f                	jae    780 <malloc+0xa0>
    ...
    if(p == freep)
 731:	8b 3d c4 0b 00 00    	mov    0xbc4,%edi
 ...
 75a:	e8 f1 fe ff ff       	call   650 <free>
  return freep;
 75f:	8b 15 c4 0b 00 00    	mov    0xbc4,%edx
 ...
 78c:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 78f:	89 15 c4 0b 00 00    	mov    %edx,0xbc4
}
 ...
 79f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 7a0:	c7 05 c4 0b 00 00 c8 	movl   $0xbc8,0xbc4
 7a7:	0b 00 00 
    base.s.size = 0;
 7aa:	bf c8 0b 00 00       	mov    $0xbc8,%edi
    base.s.ptr = freep = prevp = &base;
 7af:	c7 05 c8 0b 00 00 c8 	movl   $0xbc8,0xbc8
 7b6:	0b 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 7b9:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 7bb:	c7 05 cc 0b 00 00 00 	movl   $0x0,0xbcc
 7c2:	00 00 00 
    if(p->s.size >= nunits){
